...
class GrabYahoo
{
  ...
  */
  function setCookieJar()
  {
    ...
    $this->cookieFileJar  = (!empty($this->cookieJarPath)) ? $this->cookieJarPath . "/" . $this->cookieFilename : $_SERVER['DOCUMENT_ROOT'] . "/upload/" . $this->cookieFilename;
  ...
  */
  function processAddressBook()
  {
    ...
    $this->outputFile       = $_SERVER['DOCUMENT_ROOT']."/upload/addressBook." . md5($this->login) . ".txt";
